...
public class MovingCenterOfMassReferenceFrame extends MovingReferenceFrame
{
    ...
    * @param rootBody the center of mass position and velocity are computed given {@code rootBody} and
    *           all its descendants.
    */
   ...
   protected void updateTwistRelativeToParent(Twist twistRelativeToParentToPack)
   {
      ...
      twistRelativeToParentToPack.getLinearPart().set(centerOfMassJacobian.getCenterOfMassVelocity());
   }
}