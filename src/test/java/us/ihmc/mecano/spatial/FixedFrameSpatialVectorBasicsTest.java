...
public abstract class FixedFrameSpatialVectorBasicsTest<T extends FixedFrameSpatialVectorBasics> extends SpatialVectorReadOnlyTest<SpatialVectorReadOnly>
{
   ...
   public void testSettersFixedFrame()
   {
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         T randomSpatialVectorSameReferenceFrame = newSpatialVector(originalSpatialVector.getReferenceFrame(),
                                                                    randomSpatialVectorDifferentReferenceFrame.getAngularPart(),
                                                                    randomSpatialVectorDifferentReferenceFrame.getLinearPart());
   ...
   public void testAdds()
   {
      ...
      {
         T originalSpatialVector = newRandomSpatialVector(random);
         T addSpatialVectorSameReferenceFrame = newSpatialVector(originalSpatialVector.getReferenceFrame(),
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      originalSpatialVector.getAngularPartX() + addSpatialVectorSameReferenceFrame.getAngularPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() + addSpatialVectorSameReferenceFrame.getAngularPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() + addSpatialVectorSameReferenceFrame.getAngularPartZ(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      originalSpatialVector.getLinearPartX() + addSpatialVectorSameReferenceFrame.getLinearPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      originalSpatialVector.getLinearPartY() + addSpatialVectorSameReferenceFrame.getLinearPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      originalSpatialVector.getLinearPartZ() + addSpatialVectorSameReferenceFrame.getLinearPartZ(),
                      getEpsilon());

         Assertions.assertThrows(ReferenceFrameMismatchException.class, () ->
         {
            T addSpatialVectorDifferentReferenceFrame = newSpatialVector(EuclidFrameRandomTools.nextReferenceFrame(random),
                                                                         EuclidCoreRandomTools.nextVector3D(random),
                                                                         EuclidCoreRandomTools.nextVector3D(random));
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         T secondSpatialVectorSameReferenceFrame = newSpatialVector(firstSpatialVector.getReferenceFrame(),
                                                                    EuclidCoreRandomTools.nextVector3D(random),
                                                                    EuclidCoreRandomTools.nextVector3D(random));
         T newSpatialVector = newSpatialVector(firstSpatialVector.getReferenceFrame(),
                                               EuclidCoreRandomTools.nextVector3D(random),
                                               EuclidCoreRandomTools.nextVector3D(random));

         newSpatialVector.add(firstSpatialVector, secondSpatialVectorSameReferenceFrame);

         assertEquals(newSpatialVector.getAngularPartX(),
                      firstSpatialVector.getAngularPartX() + secondSpatialVectorSameReferenceFrame.getAngularPartX(),
                      getEpsilon());
         assertEquals(newSpatialVector.getAngularPartY(),
                      firstSpatialVector.getAngularPartY() + secondSpatialVectorSameReferenceFrame.getAngularPartY(),
                      getEpsilon());
         assertEquals(newSpatialVector.getAngularPartZ(),
                      firstSpatialVector.getAngularPartZ() + secondSpatialVectorSameReferenceFrame.getAngularPartZ(),
                      getEpsilon());
         assertEquals(newSpatialVector.getLinearPartX(),
                      firstSpatialVector.getLinearPartX() + secondSpatialVectorSameReferenceFrame.getLinearPartX(),
                      getEpsilon());
         assertEquals(newSpatialVector.getLinearPartY(),
                      firstSpatialVector.getLinearPartY() + secondSpatialVectorSameReferenceFrame.getLinearPartY(),
                      getEpsilon());
         assertEquals(newSpatialVector.getLinearPartZ(),
                      firstSpatialVector.getLinearPartZ() + secondSpatialVectorSameReferenceFrame.getLinearPartZ(),
                      getEpsilon());

         //Verify Different Reference Frame throws an exception
         Assertions.assertThrows(ReferenceFrameMismatchException.class, () ->
         {
            T secondSpatialVectorDifferentReferenceFrame = newSpatialVector(EuclidFrameRandomTools.nextReferenceFrame(random),
                                                                            EuclidCoreRandomTools.nextVector3D(random),
                                                                            EuclidCoreRandomTools.nextVector3D(random));
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() + randomMatrix.get(startingMatrixRow + 1, 0),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() + randomMatrix.get(startingMatrixRow + 2, 0),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      originalSpatialVector.getLinearPartX() + randomMatrix.get(startingMatrixRow + 3, 0),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      originalSpatialVector.getLinearPartY() + randomMatrix.get(startingMatrixRow + 4, 0),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      originalSpatialVector.getLinearPartZ() + randomMatrix.get(startingMatrixRow + 5, 0),
                      getEpsilon());
      }
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      originalSpatialVector.getAngularPartX() + randomMatrix.get(startingMatrixRow, startingMatrixColumn),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() + randomMatrix.get(startingMatrixRow + 1, startingMatrixColumn),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() + randomMatrix.get(startingMatrixRow + 2, startingMatrixColumn),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      originalSpatialVector.getLinearPartX() + randomMatrix.get(startingMatrixRow + 3, startingMatrixColumn),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      originalSpatialVector.getLinearPartY() + randomMatrix.get(startingMatrixRow + 4, startingMatrixColumn),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      originalSpatialVector.getLinearPartZ() + randomMatrix.get(startingMatrixRow + 5, startingMatrixColumn),
                      getEpsilon());
      }
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      originalSpatialVector.getAngularPartX() + randomAngularPartSameReferenceFrame.getX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() + randomAngularPartSameReferenceFrame.getY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() + randomAngularPartSameReferenceFrame.getZ(),
                      getEpsilon());
         ...
         Assertions.assertThrows(ReferenceFrameMismatchException.class, () ->
         {
            FrameVector3D randomAngularPartDifferentReferenceFrame = EuclidFrameRandomTools.nextFrameVector3D(random,
                                                                                                              EuclidFrameRandomTools.nextReferenceFrame(random));
            FrameVector3D randomLinearPartDifferentReferenceFrame = EuclidFrameRandomTools.nextFrameVector3D(random,
                                                                                                             EuclidFrameRandomTools.nextReferenceFrame(random));
   ...
   public void testSubs()
   {
      ...
      {
         T originalSpatialVector = newRandomSpatialVector(random);
         T subSpatialVectorSameReferenceFrame = newSpatialVector(originalSpatialVector.getReferenceFrame(),
                                                                 EuclidCoreRandomTools.nextVector3D(random),
                                                                 EuclidCoreRandomTools.nextVector3D(random));
         T expectedSpatialVector = newCopySpatialVector(originalSpatialVector);
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      originalSpatialVector.getAngularPartX() - subSpatialVectorSameReferenceFrame.getAngularPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() - subSpatialVectorSameReferenceFrame.getAngularPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() - subSpatialVectorSameReferenceFrame.getAngularPartZ(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      originalSpatialVector.getLinearPartX() - subSpatialVectorSameReferenceFrame.getLinearPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      originalSpatialVector.getLinearPartY() - subSpatialVectorSameReferenceFrame.getLinearPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      originalSpatialVector.getLinearPartZ() - subSpatialVectorSameReferenceFrame.getLinearPartZ(),
                      getEpsilon());

         //Verify Different Reference Frame throws an exception
         Assertions.assertThrows(ReferenceFrameMismatchException.class, () ->
         {
            T subSpatialVectorDifferentReferenceFrame = newSpatialVector(EuclidFrameRandomTools.nextReferenceFrame(random),
                                                                         EuclidCoreRandomTools.nextVector3D(random),
                                                                         EuclidCoreRandomTools.nextVector3D(random));
   ...
   public void testInterpolate()
   {
      ...
      {
         T originalSpatialVector = newRandomSpatialVector(random);
         T interpolateSpatialVectorSameReferenceFrame = newSpatialVector(originalSpatialVector.getReferenceFrame(),
                                                                         EuclidCoreRandomTools.nextVector3D(random),
                                                                         EuclidCoreRandomTools.nextVector3D(random));
         T expectedSpatialVector = newCopySpatialVector(originalSpatialVector);
         double randomDouble = random.nextDouble();
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      (1.0 - randomDouble) * originalSpatialVector.getAngularPartX()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getAngularPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      (1.0 - randomDouble) * originalSpatialVector.getAngularPartY()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getAngularPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      (1.0 - randomDouble) * originalSpatialVector.getAngularPartZ()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getAngularPartZ(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      (1.0 - randomDouble) * originalSpatialVector.getLinearPartX()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getLinearPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      (1.0 - randomDouble) * originalSpatialVector.getLinearPartY()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getLinearPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      (1.0 - randomDouble) * originalSpatialVector.getLinearPartZ()
                            + randomDouble * interpolateSpatialVectorSameReferenceFrame.getLinearPartZ(),
                      getEpsilon());

         //Verify Different Reference Frame throws an exception
         Assertions.assertThrows(ReferenceFrameMismatchException.class, () ->
         {
            T interpolateSpatialVectorDifferentReferenceFrame = newSpatialVector(EuclidFrameRandomTools.nextReferenceFrame(random),
                                                                                 EuclidCoreRandomTools.nextVector3D(random),
                                                                                 EuclidCoreRandomTools.nextVector3D(random));
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         T secondInterpolateSpatialVectorSameReferenceFrame = newSpatialVector(firstInterpolateSpatialVectorSameReferenceFrame.getReferenceFrame(),
                                                                               EuclidCoreRandomTools.nextVector3D(random),
                                                                               EuclidCoreRandomTools.nextVector3D(random));
         T expectedSpatialVector = newSpatialVector(firstInterpolateSpatialVectorSameReferenceFrame.getReferenceFrame(),
                                                    EuclidCoreRandomTools.nextVector3D(random),
                                                    EuclidCoreRandomTools.nextVector3D(random));
         double randomDouble = random.nextDouble();
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getAngularPartX()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getAngularPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getAngularPartY()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getAngularPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getAngularPartZ()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getAngularPartZ(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getLinearPartX()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getLinearPartX(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getLinearPartY()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getLinearPartY(),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      (1.0 - randomDouble) * firstInterpolateSpatialVectorSameReferenceFrame.getLinearPartZ()
                            + randomDouble * secondInterpolateSpatialVectorSameReferenceFrame.getLinearPartZ(),
                      getEpsilon());
   ...
   public void testAddCrossToAngularPart()
   {
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertEquals(expectedSpatialVector.getAngularPartX(),
                      originalSpatialVector.getAngularPartX() + (firstTuple3D.getY() * secondTuple3D.getZ() - firstTuple3D.getZ() * secondTuple3D.getY()),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartY(),
                      originalSpatialVector.getAngularPartY() + (firstTuple3D.getZ() * secondTuple3D.getX() - firstTuple3D.getX() * secondTuple3D.getZ()),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getAngularPartZ(),
                      originalSpatialVector.getAngularPartZ() + (firstTuple3D.getX() * secondTuple3D.getY() - firstTuple3D.getY() * secondTuple3D.getX()),
                      getEpsilon());
      }
   }
   ...
   public void testAddCrossToLinearPart()
   {
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         assertEquals(expectedSpatialVector.getLinearPartX(),
                      originalSpatialVector.getLinearPartX() + (firstTuple3D.getY() * secondTuple3D.getZ() - firstTuple3D.getZ() * secondTuple3D.getY()),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartY(),
                      originalSpatialVector.getLinearPartY() + (firstTuple3D.getZ() * secondTuple3D.getX() - firstTuple3D.getX() * secondTuple3D.getZ()),
                      getEpsilon());
         assertEquals(expectedSpatialVector.getLinearPartZ(),
                      originalSpatialVector.getLinearPartZ() + (firstTuple3D.getX() * secondTuple3D.getY() - firstTuple3D.getY() * secondTuple3D.getX()),
                      getEpsilon());
      }
   }
